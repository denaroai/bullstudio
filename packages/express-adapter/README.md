...
Express framework adapter for Bullstudio embedded mode.

Use this package to mount a dashboard instance inside an Express application.
The adapter serves the dashboard assets and the private dashboard API under one
mount path.

## Install

```bash
pnpm add @bullstudio/express
```
